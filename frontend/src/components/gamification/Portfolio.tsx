...
export const mockHackathonHistory: HackathonHistoryItem[] = [
  {
    id: '1',
    eventName: 'ITAM Courses Hack 2024',
  ...
  {
    id: '4',
    eventName: 'Green Tech Challenge',
  ...
  {
    id: '5',
    eventName: 'Student Hack 2023',
    date: new Date('2023-12-01'),
    teamName: 'First Steps',
    placement: null,
    totalTeams: 50,
    role: 'Developer',
    ptsEarned: 50,
